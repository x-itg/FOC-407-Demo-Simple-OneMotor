...
Svpwm_Struct gMotor1 = {
    ...
    .udc = 12.0f, // 母线电压
    .sector = 0,
    .SetChannelAHighLeaveTime_us = SetMotor1ChannelAHighLeaveTime_us,
    .SetChannelBHighLeaveTime_us = SetMotor1ChannelBHighLeaveTime_us,
    .SetChannelCHighLeaveTime_us = SetMotor1ChannelCHighLeaveTime_us,
};
...
{
    SvpwmContorol(&gMotor1, uarf, ubeta);
}
/*************************************************************
...
void SvpwmSectorJudgment(PSvpwm_Struct pSvpwm)
{
    ...
    pSvpwm->u2 = pSvpwm->uα * SVPWM_SQRT3_2 - pSvpwm->uβ / 2.0f;
    pSvpwm->u3 = -pSvpwm->uα * SVPWM_SQRT3_2 - pSvpwm->uβ / 2.0f;
